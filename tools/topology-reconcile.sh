...
offline_contract_checks() {
  ...
  grep -q '^ROUTER_LAN_BRIDGE=DBC-Bridge-Local
...
case "${1:-}" in
 ...
 "$ROOT/config/topology.env.example" || disagree "topology.example missing DBC-Bridge-Local"
  grep -q '^ROUTER_LAN_CIDR=192\.168\.1\.0/24
  grep -q '^DEV_LAN_IP=192\.168\.1\.123$' "$ROOT/config/topology.env.example" || disagree "CORE .123 missing"
  grep -q '^PROD_LAN_IP=192\.168\.1\.122$' "$ROOT/config/topology.env.example" || disagree "PROD .122 missing"
  grep -q '192\.168\.1\.1/24' "$ROOT/00-PRECHECK.rsc" || disagree "00-PRECHECK missing 192.168.1.1/24"
  grep -Fq 'lan-pool' "$ROOT/30-DHCP-DNS-NTP.rsc" || disagree "30-DHCP missing lan-pool"
...
case "${1:-}" in
 ...
 "$ROOT/config/topology.env.example" || disagree "topology.example LAN CIDR drift"
  grep -q '^ROUTER_LAN_IP=192\.168\.1\.1
  grep -q '^DEV_LAN_IP=192\.168\.1\.123$' "$ROOT/config/topology.env.example" || disagree "CORE .123 missing"
  grep -q '^PROD_LAN_IP=192\.168\.1\.122$' "$ROOT/config/topology.env.example" || disagree "PROD .122 missing"
  grep -q '192\.168\.1\.1/24' "$ROOT/00-PRECHECK.rsc" || disagree "00-PRECHECK missing 192.168.1.1/24"
  grep -Fq 'lan-pool' "$ROOT/30-DHCP-DNS-NTP.rsc" || disagree "30-DHCP missing lan-pool"
...
case "${1:-}" in
 ...
 "$ROOT/config/topology.env.example" || disagree "topology.example LAN gateway drift"
  grep -q '^DEV_LAN_IP=192\.168\.1\.123$' "$ROOT/config/topology.env.example" || disagree "CORE .123 missing"
  grep -q '^PROD_LAN_IP=192\.168\.1\.122$' "$ROOT/config/topology.env.example" || disagree "PROD .122 missing"
  grep -q '192\.168\.1\.1/24' "$ROOT/00-PRECHECK.rsc" || disagree "00-PRECHECK missing 192.168.1.1/24"
  grep -Fq 'lan-pool' "$ROOT/30-DHCP-DNS-NTP.rsc" || disagree "30-DHCP missing lan-pool"
